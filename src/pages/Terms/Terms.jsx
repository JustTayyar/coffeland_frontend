...
import { FaFileContract, FaCalendarAlt, FaChevronLeft, FaListUl } from 'react-icons/fa';
                ...
                <div className="document-main-grid">
                    ...
                    <aside className="document-sidebar">
                        ...
                        <nav className="toc-list">
                            <button onClick={() => scrollTo('s1')} className={`toc-item ${activeSection === 's1' ? 'active' : ''}`}>{t('terms.s1_title')}</button>
                            <button onClick={() => scrollTo('s2')} className={`toc-item ${activeSection === 's2' ? 'active' : ''}`}>{t('terms.s2_title')}</button>
                            <button onClick={() => scrollTo('s3')} className={`toc-item ${activeSection === 's3' ? 'active' : ''}`}>{t('terms.s3_title')}</button>
                            <button onClick={() => scrollTo('s4')} className={`toc-item ${activeSection === 's4' ? 'active' : ''}`}>{t('terms.s4_title')}</button>
                            <button onClick={() => scrollTo('s5')} className={`toc-item ${activeSection === 's5' ? 'active' : ''}`}>{t('terms.s5_title')}</button>
                        </nav>
                    </aside>
                    ...
                    <div className="document-card">
                        <header className="document-header">
                            <div className="badge-update">
                                <FaCalendarAlt /> <span>{t('terms.last_updated')}</span>
                            </div>
                            <h1>{t('terms.title')}</h1>
                        </header>
                        ...
                        <div className="document-body">
                            ...
                            <article className="document-content">
                                ...
                                <section id="s4" className="document-section">
                                    <h3>{t('terms.s4_title')}</h3>
                                    <p>{t('terms.s4_text')}</p>
                                </section>

                                <section id="s5" className="document-section">
                                    <h3>{t('terms.s5_title')}</h3>
                                    <p>{t('terms.s5_text')}</p>
                                </section>
                            </article>
                        </div>
